...
//internal static class ObjectHtmlFormatter
//{
...
//                    if (value is string text && ObjectFormatterObfuscate.MemberNames.Contains(property.Name.ToLower()))
//                    {
...
//                    if (value is string text && ObjectFormatterObfuscate.MemberNames.Contains(field.Name.ToLower()))
//                    {
//                        Append(sb, text.Obfuscate(), level, visited, options);
//                    }
//                    else
...
//            return dt.ToString(FormatInstance.DateTimeFormat);

//        if (obj is DateTimeOffset dto) 
//            return dto.ToString(FormatInstance.DateTimeOffsetFormat);
