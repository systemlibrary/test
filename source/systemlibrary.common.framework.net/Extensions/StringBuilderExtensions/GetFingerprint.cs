...
partial class StringBuilderExtensions
{
    ...
    /// <summary>
    /// Returns a 64-bit fingerprint hash of the StringBuilder contents. Returns 0 for null or empty input.
    /// </summary>
    /// <remarks>
    /// Skips characters on inputs exceeding 256 chars for performance — increases collision probability on large inputs.
    /// </remarks>
    [MethodImpl(MethodImplOptions.AggressiveOptimization)]
    public static ulong GetFingerprint(this StringBuilder input)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveOptimization)]
    static ulong GetFingerprintWithOffset(StringBuilder input, int offset)
    {
        int l = input.Length;
