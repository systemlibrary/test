...
partial class StringBuilderExtensions
{
    ...
    /// </remarks>
    public static string GetSampledKey(this StringBuilder input, string prefix = "")
    {
    ...
    static string GetSmallSampledKey(StringBuilder input)
    {
        int l = input.Length;
    ...
    [MethodImpl(MethodImplOptions.AggressiveOptimization)]
    static string GetMediumSampledKey(StringBuilder input)
    {
        int l = input.Length;
    ...
    [MethodImpl(MethodImplOptions.AggressiveOptimization)]
    static string GetLargeSampledKey(StringBuilder input)
    {
        int l = input.Length;
    ...
    [MethodImpl(MethodImplOptions.AggressiveOptimization)]
    static string GetVeryLargeSampledKey(StringBuilder input)
    {
        int l = input.Length;
